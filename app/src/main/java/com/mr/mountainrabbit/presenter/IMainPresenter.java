...
public interface IMainPresenter {
    ...
    public void LoginInOrOut(TextView user_name, TextView system_member, ImageView user_message, CircleImageView icon_draw, LinearLayout resign_draw, LinearLayout sign_login_draw, ImageView banana_yellow, ImageView banana_orange);
    //设置头像图片--网络获取
